...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-ship-service-dev-key-change-in-production')
...
DATABASE_URL = os.environ.get('DATABASE_URL', 'postgres://postgres:postgres@localhost:5432/shipping_db')
DATABASES = {
