...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-product-service-dev-key')
...
DATABASE_URL = os.environ.get('DATABASE_URL', 'postgres://postgres:postgres@localhost:5432/product_db')
DATABASES = {
