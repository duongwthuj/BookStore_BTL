...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-recommender-service-dev-key-change-in-production')
...
DATABASE_URL = os.environ.get('DATABASE_URL', 'postgres://postgres:postgres@localhost:5432/recommender_db')
DATABASES = {
