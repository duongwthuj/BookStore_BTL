...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-order-service-dev-key-change-in-production')
...
# Database
DATABASE_URL = os.environ.get('DATABASE_URL', 'postgres://postgres:postgres@localhost:5432/order_db')
DATABASES = {
